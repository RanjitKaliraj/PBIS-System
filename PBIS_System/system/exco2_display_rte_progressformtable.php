<?php
//this php page is used by exco2
...
if ($obj->tableDisplay('RTE Division')==true) {
    echo "<input style='position:relative; top:40px; left:50px;font-weight:bold;color:red' type='button' value='APPROVE' onclick='approveRTEProgressform()';/>";
    echo "<input style='position:relative; top:40px; left:50px;font-weight:bold;color:red' type='button' value='DISAPPROVE' onclick='disapproveRTEProgressform()';/>";
