...
//to display the workform of HR division and approve or edit the workform
include_once('class/work_form.php');

$obj = new Workform;

if ($obj->tableDisplay('HR Division')==true) {
    echo "<input style='position:relative; top:40px; left:40px; font-weight:bold;color:red' type='submit' value='Edit Form' onclick='editHRWorkform()';/>";
