...
function approveITProgressform(){
			...
			xmlhttp.open('POST','../system/exco1_approve_it_progressform.php', true);
...
function approveHRProgressform(){
			...
			//parameters1 = 'text1='+document.getElementById('textx2').value;
			xmlhttp.open('POST','../system/exco1_approve_hr_progressform.php', true);
			xmlhttp.setRequestHeader('Content-type','application/x-www-form-urlencoded');
...
function approveRTEProgressform(){
			...
			//parameters1 = 'text1='+document.getElementById('textx2').value;
			xmlhttp.open('POST','../system/exco1_approve_rte_progressform.php', true);
			xmlhttp.setRequestHeader('Content-type','application/x-www-form-urlencoded');
...
function disapproveITProgressform(){
			...
			//parameters1 = 'text1='+document.getElementById('textx2').value;
			xmlhttp.open('POST','../system/exco1_disapprove_it_progressform.php', true);
			xmlhttp.setRequestHeader('Content-type','application/x-www-form-urlencoded');
...
function disapproveHRProgressform(){
			...
			//parameters1 = 'text1='+document.getElementById('textx2').value;
			xmlhttp.open('POST','../system/exco1_disapprove_hr_progressform.php', true);
			xmlhttp.setRequestHeader('Content-type','application/x-www-form-urlencoded');
...
function disapproveRTEProgressform(){
			...
			//parameters1 = 'text1='+document.getElementById('textx2').value;
			xmlhttp.open('POST','../system/exco1_disapprove_rte_progressform.php', true);
			xmlhttp.setRequestHeader('Content-type','application/x-www-form-urlencoded');
